...
from app.schemas.agents import AgentRole, SafeAgentErrorEnvelope
...
class MultiAgentAnalysisOrchestrator:
    def __init__(
        ...
        self.last_error_envelopes: list[SafeAgentErrorEnvelope] = []
        ...
        try:
            ...
            self.last_error_envelopes = [
                SafeAgentErrorEnvelope(
                    ...
                    code="multi_agent_enrichment_failed",
                    message=(
                        "Multi-agent enrichment failed; the base analysis report "
                        "was returned."
                    ),
                    retryable=True,
                )
